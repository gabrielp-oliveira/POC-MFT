...
export class TooltipDirective {
  ...
  create() {
    ...
    this.renderer.setStyle(this.tooltip, 'background', `gray`);
    this.renderer.setStyle(this.tooltip, 'padding', `3px 5px`);
    ...
    this.renderer.setStyle(this.tooltip, 'font-wheight', `700`);
